          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="relative">
              ...
              <img 
                ...
                src="src/assets/images/travelers.svg" 
                alt="Travelers"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <CardHeader>
                <CardTitle 
                   ...
                   <div class="flex items-center gap-3">
                      <img alt="" loading="lazy" width="300" height="300" decoding="async" data-nimg="1" class="h-[3rem] w-auto md:h-[5rem]" src="src/assets/images/map.webp" />
            ...
            <Card className="w-full">
              ...
              <CardTitle 
                    className="text-xl font-bold">
                   <div class="flex items-center gap-3">
                      <img alt="" loading="lazy" width="300" height="300" decoding="async" data-nimg="1" class="h-[3rem] w-auto md:h-[5rem]" src="src/assets/images/story.webp" />
            ...
            <Card className="w-full">
              ...
              <CardTitle 
                   ...
                   <div class="flex items-center gap-2">
                      <img alt="" loading="lazy" width="300" height="300" decoding="async" data-nimg="1" class="h-[3rem] w-auto md:h-[5rem]" src="src/assets/images/food.webp" />
